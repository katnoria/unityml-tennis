...
class MADDPGAgent(object):
    ...
    """
    def __init__(
        self, state_size, action_size, num_agents, agent_index, writer,
...
class MADDPGAgentTrainer(): 
    ...
    def __init__(
        self, state_size, action_size, num_agents, writer, random_seed,
        ...
        self.agents = [
            MADDPGAgent(
                ...
                writer=self.writer, random_seed=random_seed, dirname=dirname,
